# Python package 'quickqanava' initialization.
#
...
# presents it as package quickqanava.
...
if QT_BINDING == 'pyside':
    ...
    # This depends on quickqanava/manifest.xml listing ${prefix}/lib in the python path.
    import libquickqanava_shiboken

    # Expose the contained quickqanava namespace directly
    sys.modules['quickqanava'] = libquickqanava_shiboken.quickqanava

elif QT_BINDING == 'pyqt':

    # Import the shared library generated by the sip binding-generator.
    # This depends on quickqanava/manifest.xml listing ${prefix}/lib in the python path.
    import libquickqanava_sip

    # Expose the contained quickqanava namespace directly
    sys.modules['quickqanava'] = libquickqanava_sip.qan
